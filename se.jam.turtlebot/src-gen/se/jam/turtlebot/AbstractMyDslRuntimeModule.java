...
import se.jam.turtlebot.formatting.MyDslFormatter;
import se.jam.turtlebot.generator.MyDslGenerator;
import se.jam.turtlebot.parser.antlr.MyDslAntlrTokenFileProvider;
import se.jam.turtlebot.parser.antlr.MyDslParser;
import se.jam.turtlebot.parser.antlr.internal.InternalMyDslLexer;
import se.jam.turtlebot.scoping.MyDslScopeProvider;
import se.jam.turtlebot.serializer.MyDslSemanticSequencer;
import se.jam.turtlebot.serializer.MyDslSyntacticSequencer;
import se.jam.turtlebot.services.MyDslGrammarAccess;
import se.jam.turtlebot.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "se/jam/turtlebot/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("se.jam.turtlebot.MyDsl");
	}
