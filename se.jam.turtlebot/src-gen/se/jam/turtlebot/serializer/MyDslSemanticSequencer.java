 ...
 */
package se.jam.turtlebot.serializer;
...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Area(ISerializationContext context, Area semanticObject) {
		...
		feeder.accept(grammarAccess.getAreaAccess().getXmaxEIntParserRuleCall_4_0(), semanticObject.getXmax());
		feeder.accept(grammarAccess.getAreaAccess().getYmaxEIntParserRuleCall_8_0(), semanticObject.getYmax());
		feeder.finish();
	}
